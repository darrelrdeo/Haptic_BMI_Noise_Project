...
static const int trialsPerExperimentBlock = 350;	  // trials per experiment block, same as number of targets
static const int trialsBeforeBreak = 30;
static const int trialTime = 10;                  // max time per trial or washout [sec]
static const int breakTime = 30;                 // break time [sec] between blocks
static const int preblockTime = 10;               // time to display message [sec]
static const int recordTime = 2;                  // time to record data [sec]
static const int relaxTime = 45;				// time to relax between large strings of trials within same block
